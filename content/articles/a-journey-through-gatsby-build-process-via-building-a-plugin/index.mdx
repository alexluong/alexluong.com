...
- Muhammad Muhajir's [`gatsby-starter-firebase`](https://github.com/muhajirdev/gatsby-starter-firebase/)
...
And if you use Firebase with Gatsby, consider using my plugin [`gatsby-plugin-firebase`](https://github.com/alexluong/gatsby-plugin-firebase) maybe?